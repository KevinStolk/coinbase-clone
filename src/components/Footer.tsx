...
const Footer = () => {
    return (
        <div className="border border-secondary shadow-xl bg-primary px-2 w-full mt-8 pt-8 text-primary">
                        ...
                        <div className="w-full md:w-[300px] py-4 relative">
                            ...
                            <div className="py-4">
                                <form>
                                    ...
                                    />
                                    <button className="bg-button text-btnText px-4 p-2 w-full rounded-md shadow-xl hover:shadow-2xl md:w-auto my-2">
                                        Sign up
                                    </button>
                                </form>
                            </div>
